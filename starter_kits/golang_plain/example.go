...
// AppManager.
var client_id          = "0294a68c2dd7925e"
var client_secret      = "57c27addb97002f24bd75e604e221e04"
// Fidor's OAuth Endpoint (this changes between Sandbox and Production)
var fidor_oauth_url = "http://localhost:4001/oauth"  // e.g https://fidor.com/api_sandbox/oauth
// The OAuth Endpoint this App provides
var oauth_cb_url    = "http://localhost:8080"
// The URL of the Fidor API (this changes between Sandbox and
// Production)
var fidor_api_url   = "http://localhost:4001"   // e.g https://fidor.com/api_sandbox vs /api
